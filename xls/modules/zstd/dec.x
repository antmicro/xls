...
import xls.modules.zstd.raw_block_dec_new_mem;
import xls.modules.zstd.rle_block_dec_new_mem2;
...
> {
    ...
    type RleBlockDecoderStatus = rle_block_dec_new_mem2::RleBlockDecoderStatus;
    type RleBlockDecoderReq = rle_block_dec_new_mem2::RleBlockDecoderReq<AXI_ADDR_W>;
    type RleBlockDecoderResp = rle_block_dec_new_mem2::RleBlockDecoderResp;
...
proc ZstdDecoderInternalTest {
    ...
    type RleBlockDecoderReq = rle_block_dec_new_mem2::RleBlockDecoderReq<TEST_AXI_ADDR_W>;
    type RleBlockDecoderResp = rle_block_dec_new_mem2::RleBlockDecoderResp;
    type RleBlockDecoderStatus = rle_block_dec_new_mem2::RleBlockDecoderStatus;
...
> {
    ...
    config(
        ...
        spawn rle_block_dec_new_mem2::RleBlockDecoder<AXI_DATA_W>(
...
proc ZstdDecoderInternalInst {
    ...
    type RleBlockDecoderReq = rle_block_dec_new_mem2::RleBlockDecoderReq<INST_AXI_ADDR_W>;
    type RleBlockDecoderResp = rle_block_dec_new_mem2::RleBlockDecoderResp;
