...
async def test_writer(dut, mem_size, ctrl_input, write_req_input, data_in_input, write_resp_expect, memory_verification, expected_memory, resp_cnt):
  GENERIC_CTRL_CHANNEL = "ctrl"
  ...
  driver_ctrl = XLSChannelDriver(dut, GENERIC_CTRL_CHANNEL, dut.clk)
  ...
  monitor_ctrl = XLSChannelMonitor(dut, GENERIC_CTRL_CHANNEL, dut.clk, CtrlStruct)
  ...
  await cocotb.start(driver_ctrl.send(ctrl_input))
...
async def ram_test_single_burst_1_transfer(dut):
  ...
  (ctrl_input, write_req_input, data_in_input, write_resp_expect, memory_verification, expected_memory, resp_cnt) = generate_test_data_arbitrary(mem_size, test_cases_single_burst_1_transfer)
  await test_writer(dut, mem_size, ctrl_input, write_req_input, data_in_input, write_resp_expect, memory_verification, expected_memory, resp_cnt)

@cocotb.test(timeout_time=20000, timeout_unit="ms")
async def ram_test_single_burst_2_transfers(dut):
  mem_size = 2**ADDR_WIDTH

  (ctrl_input, write_req_input, data_in_input, write_resp_expect, memory_verification, expected_memory, resp_cnt) = generate_test_data_arbitrary(mem_size, test_cases_single_burst_2_transfers)
  await test_writer(dut, mem_size, ctrl_input, write_req_input, data_in_input, write_resp_expect, memory_verification, expected_memory, resp_cnt)
...
async def ram_test_single_burst_almost_max_burst_transfer(dut):
  ...
  (ctrl_input, write_req_input, data_in_input, write_resp_expect, memory_verification, expected_memory, resp_cnt) = generate_test_data_arbitrary(mem_size, test_cases_single_burst_almost_max_burst_transfer)
  await test_writer(dut, mem_size, ctrl_input, write_req_input, data_in_input, write_resp_expect, memory_verification, expected_memory, resp_cnt)
...
async def ram_test_single_burst_max_burst_transfer(dut):
  ...
  (ctrl_input, write_req_input, data_in_input, write_resp_expect, memory_verification, expected_memory, resp_cnt) = generate_test_data_arbitrary(mem_size, test_cases_single_burst_max_burst_transfer)
  await test_writer(dut, mem_size, ctrl_input, write_req_input, data_in_input, write_resp_expect, memory_verification, expected_memory, resp_cnt)
...
async def ram_test_multiburst_2_full_bursts(dut):
  ...
  (ctrl_input, write_req_input, data_in_input, write_resp_expect, memory_verification, expected_memory, resp_cnt) = generate_test_data_arbitrary(mem_size, test_cases_multiburst_2_full_bursts)
  await test_writer(dut, mem_size, ctrl_input, write_req_input, data_in_input, write_resp_expect, memory_verification, expected_memory, resp_cnt)
...
async def ram_test_multiburst_1_full_burst_and_single_transfer(dut):
  ...
  (ctrl_input, write_req_input, data_in_input, write_resp_expect, memory_verification, expected_memory, resp_cnt) = generate_test_data_arbitrary(mem_size, test_cases_multiburst_1_full_burst_and_single_transfer)
  await test_writer(dut, mem_size, ctrl_input, write_req_input, data_in_input, write_resp_expect, memory_verification, expected_memory, resp_cnt)
...
async def ram_test_multiburst_crossing_4kb_boundary(dut):
  ...
  (ctrl_input, write_req_input, data_in_input, write_resp_expect, memory_verification, expected_memory, resp_cnt) = generate_test_data_arbitrary(mem_size, test_cases_multiburst_crossing_4kb_boundary)
  await test_writer(dut, mem_size, ctrl_input, write_req_input, data_in_input, write_resp_expect, memory_verification, expected_memory, resp_cnt)
...
async def ram_test_multiburst_crossing_4kb_boundary_with_perfectly_aligned_full_bursts(dut):
  ...
  (ctrl_input, write_req_input, data_in_input, write_resp_expect, memory_verification, expected_memory, resp_cnt) = generate_test_data_arbitrary(mem_size, test_cases_multiburst_crossing_4kb_boundary_with_perfectly_aligned_full_bursts)
  await test_writer(dut, mem_size, ctrl_input, write_req_input, data_in_input, write_resp_expect, memory_verification, expected_memory, resp_cnt)
...
async def ram_test_multiburst_crossing_4kb_boundary_with_2_full_bursts_and_1_transfer(dut):
  ...
  (ctrl_input, write_req_input, data_in_input, write_resp_expect, memory_verification, expected_memory, resp_cnt) = generate_test_data_arbitrary(mem_size, test_cases_multiburst_crossing_4kb_boundary_with_2_full_bursts_and_1_transfer)
  await test_writer(dut, mem_size, ctrl_input, write_req_input, data_in_input, write_resp_expect, memory_verification, expected_memory, resp_cnt)
...
async def ram_test_random(dut):
  ...
  (ctrl_input, write_req_input, data_in_input, write_resp_expect, memory_verification, expected_memory, resp_cnt) = generate_test_data_random(test_count, mem_size)
  await test_writer(dut, mem_size, ctrl_input, write_req_input, data_in_input, write_resp_expect, memory_verification, expected_memory, resp_cnt)
...
def generate_test_data_random(test_count, mem_size):
  ...
  xfer_baseaddr = random.randrange(0, (mem_size / 2))
  ctrl = CtrlStruct(base = xfer_baseaddr)
  ctrl_input.append(ctrl)
  ...
  return (ctrl_input, write_req_input, data_in_input, write_resp_expect, memory_verification, memory, test_count)
