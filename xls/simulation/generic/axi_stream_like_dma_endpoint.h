...
class AxiStreamLikeDmaEndpoint final : public IDmaEndpoint {
 public:
  ...
  size_t FifoSpaceLeft() const override;
  absl::Status Write(const Payload& payload) override;
  absl::Status Read(Payload& payload) override;
