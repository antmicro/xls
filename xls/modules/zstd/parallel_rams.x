...
> (
    ...
    let max_ptr = max_hb_ptr_for_sequence_packet<HISTORY_BUFFER_SIZE_KB, RAM_ADDR_WIDTH, RAM_DATA_WIDTH>(ptr, seq);
    let req0 = sequence_packet_to_single_read_req<HISTORY_BUFFER_SIZE_KB, RAM_ADDR_WIDTH, RAM_DATA_WIDTH>(ptr, max_ptr, seq, RamNumber:0);
    let req1 = sequence_packet_to_single_read_req<HISTORY_BUFFER_SIZE_KB, RAM_ADDR_WIDTH, RAM_DATA_WIDTH>(ptr, max_ptr, seq, RamNumber:1);
    let req2 = sequence_packet_to_single_read_req<HISTORY_BUFFER_SIZE_KB, RAM_ADDR_WIDTH, RAM_DATA_WIDTH>(ptr, max_ptr, seq, RamNumber:2);
    let req3 = sequence_packet_to_single_read_req<HISTORY_BUFFER_SIZE_KB, RAM_ADDR_WIDTH, RAM_DATA_WIDTH>(ptr, max_ptr, seq, RamNumber:3);
    let req4 = sequence_packet_to_single_read_req<HISTORY_BUFFER_SIZE_KB, RAM_ADDR_WIDTH, RAM_DATA_WIDTH>(ptr, max_ptr, seq, RamNumber:4);
    let req5 = sequence_packet_to_single_read_req<HISTORY_BUFFER_SIZE_KB, RAM_ADDR_WIDTH, RAM_DATA_WIDTH>(ptr, max_ptr, seq, RamNumber:5);
    let req6 = sequence_packet_to_single_read_req<HISTORY_BUFFER_SIZE_KB, RAM_ADDR_WIDTH, RAM_DATA_WIDTH>(ptr, max_ptr, seq, RamNumber:6);
    let req7 = sequence_packet_to_single_read_req<HISTORY_BUFFER_SIZE_KB, RAM_ADDR_WIDTH, RAM_DATA_WIDTH>(ptr, max_ptr, seq, RamNumber:7);
