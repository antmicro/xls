...
class RegisterMockTest : public ::testing::Test {};

TEST_F(RegisterMockTest, Init1) {
  RegisterMock<17> mock;
  ASSERT_THAT(mock.bytes(), ElementsAre(0, 0, 0));
}

TEST_F(RegisterMockTest, Init2) {
  RegisterMock<31> mock{{1, 2, 3, 4}};
  ASSERT_THAT(mock.bytes(), ElementsAre(1, 2, 3, 4));
}

TEST_F(RegisterMockTest, SetBytes) {
  RegisterMock<31> mock{};
  mock.bytes() = {3, 4, 5, 6};
  ASSERT_THAT(mock.bytes(), ElementsAre(3, 4, 5, 6));
}

TEST_F(RegisterMockTest, GetChannelWidth) {
  RegisterMock<31> mock{};
  ASSERT_EQ(mock.GetChannelWidth(), 31);
}

TEST_F(RegisterMockTest, GetPayloadData8) {
  RegisterMock<17> mock{{1, 2, 3}};
...
TEST_F(RegisterMockTest, GetPayloadData16) {
  RegisterMock<35> mock{{1, 2, 3, 4, 5}};
...
TEST_F(RegisterMockTest, GetPayloadData32) {
  RegisterMock<35> mock{{1, 2, 3, 4, 5}};
...
TEST_F(RegisterMockTest, GetPayloadData64) {
  RegisterMock<70> mock{{1, 2, 3, 4, 5, 6, 7, 8, 9}};
...
TEST_F(RegisterMockTest, CheckBitmasking) {
  RegisterMock<3> mock{};
...
TEST_F(RegisterMockTest, SetPayloadData8) {
  RegisterMock<17> mock{};
  XLS_EXPECT_OK(mock.SetPayloadData8(0, 1));
...
TEST_F(RegisterMockTest, SetPayloadData16) {
  RegisterMock<17> mock{};
...
TEST_F(RegisterMockTest, SetPayloadData32) {
  RegisterMock<33> mock{};
...
TEST_F(RegisterMockTest, SetPayloadData64) {
  RegisterMock<70> mock{};
