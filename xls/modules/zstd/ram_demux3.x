...
> {
    ...
    config(
        ...
        spawn ram_demux::RamDemuxFixed<ADDR_WIDTH, DATA_WIDTH, NUM_PARTITIONS, u32:0xFF, D1_INIT_SEL, QUEUE_LEN>(
        ...
        spawn ram_demux::RamDemuxFixed<ADDR_WIDTH, DATA_WIDTH, NUM_PARTITIONS, u32:0xFE, D2_INIT_SEL, QUEUE_LEN>(
