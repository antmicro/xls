...
class IrAxiStreamLike final : public IAxiStreamLike {
 public:
  ...
  size_t FifoCount() const override;
  absl::Status Transfer() override;

  void SetDataValid(uint64_t begin, uint64_t end) override;
  std::pair<uint64_t, uint64_t> GetDataValid() const override;
