...
absl::Status SingleValueManager::RegisterChannel(std::unique_ptr<IChannel> reg,
                                                 uint64_t offset) {
  if (reg == nullptr) {
...
absl::StatusOr<IChannel*> SingleValueManager::GetMappingOrStatus(
...
static constexpr absl::Status (*SetPayloadWPow[4])(IChannel*, uint64_t,
                                                   uint64_t) = {
    [](IChannel* stream, uint64_t addr, uint64_t data) -> absl::Status {
...
static constexpr absl::StatusOr<uint64_t> (*GetPayloadWPow[4])(IChannel*,
                                                               uint64_t) = {
    [](IChannel* stream, uint64_t addr) -> absl::StatusOr<uint64_t> {
...
absl::StatusOr<uint64_t> SingleValueManager::ReadInternal(
  ...
  XLS_ASSIGN_OR_RETURN(IChannel * reg,
