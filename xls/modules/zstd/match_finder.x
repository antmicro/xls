...
> {
   ...
   // HistoryBuffer interface
    ...
    config (
        ...
        let (inp_buf_req_s, inp_buf_req_r) = chan<InputBufferReq>("inp_buf_req");
        let (inp_buf_next_s, inp_buf_next_r) = chan<()>("inp_buf_next");
        let (inp_buf_out_s, inp_buf_out_r) = chan<InputBufferResp>("inp_buf_out");
    ...
    next (state: State) {
        ...
        let tok1_2 = send_if(tok0, inp_buf_next_s, do_send_inp_buf_next, ());
        ...
        let tok1_2 = send_if(tok0, inp_buf_next_s, ht_is_match, ());
        ...
        let tok1_2 = send_if(tok0, inp_buf_next_s, is_next_match, ());
