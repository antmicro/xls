...
> {
    ...
    config(
        ...
        axi_ram_ar_s: chan<MemAxiAr>[AXI_CHAN_N] out,
        axi_ram_r_r: chan<MemAxiR>[AXI_CHAN_N] in,
        ...
        (cmp_output_s, comp_block_req_s, comp_block_resp_r)
    }
...
const INST_FSE_RAM_DATA_W = u32:48;
